"""Sanity checks for the attention and frac_attn copolymer fusion modes.
...
from chemprop.models.copolymer import CopolymerMPNN, MonomerScorer
...
def test_output_dim_consistency():
    ...
    d_mp_target = 64
    modes_same_dim = ["mean", "mix", "attention", "frac_attn"]
    B = 2
    dims = {}
