...
python3 scripts/python/evaluate_model.py \
    --model_name DMPNN --dataset_name insulator --checkpoint_path /Users/u6788552/Desktop/experiments/dmpnn/checkpoints/DMPNN/insulator__bandgap_chain__batch_norm__rep0
