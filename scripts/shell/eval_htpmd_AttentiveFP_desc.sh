...
python3 scripts/python/evaluate_model.py \
    --model_name AttentiveFP --dataset_name htpmd --checkpoint_path "/scratch/um09/hl4138/dmpnn/checkpoints/AttentiveFP/htpmd__Conductivity__desc__rep0/best.pt" --preprocessing_path "/scratch/um09/hl4138/dmpnn/preprocessing/htpmd__Conductivity__desc__rep0"
