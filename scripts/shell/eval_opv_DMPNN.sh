...
python3 scripts/python/evaluate_model.py \
    --model_name DMPNN --dataset_name opv --checkpoint_path "/scratch/um09/hl4138/dmpnn/checkpoints/DMPNN/opv_camb3lyp__delta_homo__rep0/logs/checkpoints/epoch=87-step=78408.ckpt"
