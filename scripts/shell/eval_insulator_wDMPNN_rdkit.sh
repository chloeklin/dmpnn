...
python3 scripts/python/evaluate_model.py \
    --model_name wDMPNN --dataset_name insulator --checkpoint_path "/scratch/um09/hl4138/dmpnn/checkpoints/wDMPNN/insulator__bandgap_chain__rdkit__rep0/logs/checkpoints/epoch=63-step=13248.ckpt" --preprocessing_path "/scratch/um09/hl4138/dmpnn/preprocessing/insulator__bandgap_chain__rdkit__rep0"
