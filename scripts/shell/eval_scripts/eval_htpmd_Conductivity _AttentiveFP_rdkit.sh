#!/bin/bash
#PBS -N eval_htpmd_Conductivity _AttentiveFP
...
python3 /Users/u6788552/Desktop/experiments/dmpnn/scripts/python/evaluate_model.py \
    ...
    --dataset_name htpmd \
    --target Conductivity  \
    --checkpoint_path "/Users/u6788552/Desktop/experiments/dmpnn/checkpoints/AttentiveFP/htpmd__Conductivity__rdkit__rep0/best.pt" \
     \
    --incl_rdkit
