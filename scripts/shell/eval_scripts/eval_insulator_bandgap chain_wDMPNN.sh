#!/bin/bash
#PBS -N eval_insulator_bandgap chain_wDMPNN
...
python3 /Users/u6788552/Desktop/experiments/dmpnn/scripts/python/evaluate_model.py \
    ...
    --target bandgap chain \
    --checkpoint_path "/Users/u6788552/Desktop/experiments/dmpnn/checkpoints/wDMPNN/insulator__bandgap_chain__rep0/logs/checkpoints/epoch=81-step=4264-v1.ckpt" \
     \
