#!/bin/bash
#PBS -N eval_insulator_bandgap chain _AttentiveFP
...
python3 /Users/u6788552/Desktop/experiments/dmpnn/scripts/python/evaluate_model.py \
    ...
    --target bandgap chain  \
    --checkpoint_path "/Users/u6788552/Desktop/experiments/dmpnn/checkpoints/AttentiveFP/insulator__bandgap_chain__rdkit__rep0/best.pt" \
     \
    --incl_rdkit

echo "Evaluation completed for AttentiveFP on insulator::bandgap chain "
