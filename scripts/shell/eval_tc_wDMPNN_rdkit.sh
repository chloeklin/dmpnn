...
python3 scripts/python/evaluate_model.py \
    --model_name wDMPNN --dataset_name tc --incl_rdkit --checkpoint_path "/scratch/um09/hl4138/dmpnn/checkpoints/wDMPNN/tc__TC__rdkit__rep0/logs/checkpoints/epoch=38-step=1872.ckpt" --preprocessing_path "/scratch/um09/hl4138/dmpnn/preprocessing/tc__TC__rdkit__rep0"
